...
public:
	...
	// Original Textures (Before compression) used to generate this asset
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "PCA Raw Data")
	TArray<TObjectPtr<UTexture2D>> RawTextures;

	// Compressed Feature Maps (Latent Maps generated by Python)
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "PCA Compressed Data")
	TArray<FPCATextureParam> FeatureMaps;
